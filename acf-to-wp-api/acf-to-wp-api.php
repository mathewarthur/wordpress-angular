...
class ACFtoWPAPI {
	...
	private function _versionTwoSetup() {
		...
		add_action( 'rest_api_init', array( $this, 'addACFDataCategoryV2' ) ); // Category
	...
	function addACFDataCategoryV2() {
		register_api_field( 'category',
	        'acf',
	        array(
	            'get_callback'    => array( $this, 'addACFDataCategoryV2cb' ),
	            'update_callback' => null,
	            'schema'          => null,
	        )
	    );
	...
	function addACFDataCategoryV2cb($object, $fieldName, $request) {
		return $this->_getData($object['id'], 'term', $object);
	}
