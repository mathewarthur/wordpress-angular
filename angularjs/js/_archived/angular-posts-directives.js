...
angular_app.directive('ngAnother', ['$http', '$rootScope', function($http, $rootScope){
	return {
		transclude: true,
		restrict: 'E',
		scope: {
    ...
    link: function($scope, $elm, attrs, ctrl){
		...
		template: '<div class="ngSingleWrapper"><ng-include src="\''+wpAngularVars.template_directory.another_template+'\'"></ng-include></div>'
	}
}]);
...
angular_app.directive('ngBananas', ['$http', '$rootScope', function($http, $rootScope){
  return {
    transclude: true,
    restrict: 'E',
    scope: {
    ...
    template: '<div class="ngListWrapper" ng-repeat="post in postsD"><ng-include src="\''+wpAngularVars.template_directory.test_template+'\'"></ng-include></div>'
  }
}]);